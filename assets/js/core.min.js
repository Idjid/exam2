...
const fullName = "Erlan Bakirov";  
const namePlaceholder = document.getElementById("name-erlan");
...
const email = "erlanshka@gmail.com";

window.onload = function() {    
    document.getElementById("changeling").addEventListener("click", function() {
        let name;
        while (true) {
            name = prompt("So... what is your name?");            
            if (name && isNaN(name)) {
                document.getElementById("name-erlan").textContent = name;
                break;
            } else {
    ...
    document.getElementById("email-erlan").textContent = email;
};


//I don't like to leave comments but today I will. You know why? Just look at the code under this comment...
document.getElementById("items").addEventListener("click", function() {
    let numberOfItems;
    while (true) {
        numberOfItems = prompt("How many items? (1-10):");
        numberOfItems = parseInt(numberOfItems, 10);

        if (!isNaN(numberOfItems) && numberOfItems > 0 && numberOfItems <= 10) {
            break;
        } else {
            alert("Dude, i asked between 1 and 10! Are you blind?");
        }
    }
    ...
    for (let i = 1; i <= numberOfItems; i++) {
        ...
        itemDiv.className = "d-flex mb-4";

        const iconDiv = document.createElement("div");
        iconDiv.className = "text-primary";
        //I used `` because the code alredy has "" and it will not work if I use '' or ""
        iconDiv.innerHTML = `<img width="40" height="20" src="demo.files/svg/various/line-chart.svg" alt="...">`;

        const contentDiv = document.createElement("div");
        contentDiv.className = "mx-2";

        const heading = document.createElement("h3");
        heading.className = "h5 fw-bold mb-1";
        //about `` here... I don't know. I spend 20 minutes trying to make it work! I dunno why "" or '' don't work here...
...
//if somebody read this... KILL ME! IT WAS GOD DAMN HELL!!!
